...
AnalyticsEvent _$AnalyticsEventFromJson(Map<String, dynamic> json) => AnalyticsEvent(
...
AnalyticsBatch _$AnalyticsBatchFromJson(Map<String, dynamic> json) => AnalyticsBatch(
  batchId: json['batch_id'] as String,
  events: (json['events'] as List).map((e) => _$AnalyticsEventFromJson(e as Map<String, dynamic>)).toList(),
