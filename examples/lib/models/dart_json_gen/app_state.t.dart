...
extension $AppStateString on AppState {
  String toStringRepresentation() =>
      'AppState(counter: ${counter}, isLoading: ${isLoading}, errorMessage: ${errorMessage}, lastUpdated: ${lastUpdated})';
}
...
extension $UserProfileEquatable on UserProfile {
  List<Object?> get props =>
      [id, displayName, bio, tags, createdAt, internalToken];
...
extension $UserProfileString on UserProfile {
  String toStringRepresentation() =>
      'UserProfile(id: ${id}, displayName: ${displayName}, bio: ${bio}, tags: ${tags}, createdAt: ${createdAt})';
}
...
extension $SettingsString on Settings {
  String toStringRepresentation() =>
      'Settings(darkMode: ${darkMode}, locale: ${locale}, fontSize: ${fontSize})';
}
