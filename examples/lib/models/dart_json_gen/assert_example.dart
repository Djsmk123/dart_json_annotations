...
class AssertExample {
  ...
  factory AssertExample.fromJson(Map<String, dynamic> json) =>
      _$AssertExampleFromJson(json);
}
...
class AssertWithMessage {
  ...
  factory AssertWithMessage.fromJson(Map<String, dynamic> json) =>
      _$AssertWithMessageFromJson(json);
}
