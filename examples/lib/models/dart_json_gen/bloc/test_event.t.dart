...
extension $TestEventUnion on TestEvent {
  T when<T>({
    ...
    required T Function({required String id, required bool forceRefresh}) loadData,
    required T Function({required String id, String? metadata, bool? validate}) saveData,
    ...
    TestEventSaveData v => saveData(id: v.id, metadata: v.metadata, validate: v.validate),
  ...
  T maybeWhen<T>({
    ...
    T Function({required String id, String? metadata, bool? validate})? saveData,
    ...
    TestEventUpdateCounter v when updateCounter != null => updateCounter(v.delta, v.source),
    TestEventLoadData v when loadData != null => loadData(id: v.id, forceRefresh: v.forceRefresh),
    TestEventSaveData v when saveData != null => saveData(id: v.id, metadata: v.metadata, validate: v.validate),
    TestEventDecrement v when decrement != null => decrement(v.value, reason: v.reason),
  ...
  TestEventIncrement? get asIncrement => this is TestEventIncrement ? this as TestEventIncrement : null;
  TestEventReset? get asReset => this is TestEventReset ? this as TestEventReset : null;
  TestEventSetValue? get asSetValue => this is TestEventSetValue ? this as TestEventSetValue : null;
  TestEventUpdateCounter? get asUpdateCounter => this is TestEventUpdateCounter ? this as TestEventUpdateCounter : null;
  TestEventLoadData? get asLoadData => this is TestEventLoadData ? this as TestEventLoadData : null;
  TestEventSaveData? get asSaveData => this is TestEventSaveData ? this as TestEventSaveData : null;
  TestEventDecrement? get asDecrement => this is TestEventDecrement ? this as TestEventDecrement : null;
  TestEventFetchData? get asFetchData => this is TestEventFetchData ? this as TestEventFetchData : null;
}
...
class TestEventSetValue extends TestEvent {
  ...
  @override
  bool operator ==(Object other) =>
    identical(this, other) || other is TestEventSetValue && value == other.value;
...
class TestEventUpdateCounter extends TestEvent {
  ...
  @override
  bool operator ==(Object other) =>
    identical(this, other) || other is TestEventUpdateCounter && delta == other.delta && source == other.source;
...
class TestEventLoadData extends TestEvent {
  ...
  @override
  bool operator ==(Object other) =>
    identical(this, other) || other is TestEventLoadData && id == other.id && forceRefresh == other.forceRefresh;
...
class TestEventSaveData extends TestEvent {
  ...
  @override
  bool operator ==(Object other) =>
    identical(this, other) || other is TestEventSaveData && id == other.id && metadata == other.metadata && validate == other.validate;
...
class TestEventDecrement extends TestEvent {
  ...
  @override
  bool operator ==(Object other) =>
    identical(this, other) || other is TestEventDecrement && value == other.value && reason == other.reason;
