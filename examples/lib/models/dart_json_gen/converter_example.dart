...
part 'converter_example.gen.dart';

/// Example: Custom JSON converter for DateTime
class DateTimeConverter implements json_annotation.JsonConverter<DateTime, String> {
...
class DurationConverter implements json_annotation.JsonConverter<Duration, int> {
