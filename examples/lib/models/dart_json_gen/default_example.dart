...
class DefaultExample {
  ...
  factory DefaultExample.fromJson(Map<String, dynamic> json) => _$DefaultExampleFromJson(json);
}
...
class DefaultNullableExample {
  ...
  factory DefaultNullableExample.fromJson(Map<String, dynamic> json) => _$DefaultNullableExampleFromJson(json);
}
