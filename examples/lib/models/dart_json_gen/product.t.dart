...
Product _$ProductFromJson(Map<String, dynamic> json) => Product(
    ...
    variants: (json['variants'] as List)
        .map((e) => _$ProductVariantFromJson(e as Map<String, dynamic>))
        .toList(),
...
extension $ProductEquatable on Product {
  List<Object?> get props =>
      [id, name, description, price, stockCount, categories, variants, meta];
...
extension $ProductString on Product {
  String toStringRepresentation() =>
      'Product(id: ${id}, name: ${name}, description: ${description}, price: ${price}, stockCount: ${stockCount}, categories: ${categories}, variants: ${variants}, meta: ${meta})';
}
